...
<body>
    ...
    <div class="form-area">
        <form action="data.php" method="post">
            ...
            <input name="class" placeholder="CLASS (Economy/Business)" type="text">
            <input name="jdate" placeholder="Journey Date (yyyy-mm-dd)" type="text">
            <input name="ttype" placeholder="Ticket Type (Single Trip/Weekly Pass/Monthly Pass)" type="text">
            <input name="p_id" placeholder="Passenger ID" type="number">
            <input name="p_method" placeholder="Payment Method (bKash/Nagad)" type="text">
